...
function register(app, db) {
    // ── Dashboard ─────────────────────────────────────────
    app.get('/portal/api/dashboard', auth_1.authMiddleware, (req, res) => {
        const now = new Date();
    ...
    // ── Custom Orders ─────────────────────────────────────
    app.get('/portal/api/custom-orders', auth_1.authMiddleware, (req, res) => {
        res.json(db.prepare('SELECT * FROM custom_orders ORDER BY created_at DESC').all());
    });
    app.post('/portal/api/custom-orders', auth_1.authMiddleware, (req, res) => {
    ...
    app.patch('/portal/api/custom-orders/:id', auth_1.authMiddleware, (req, res) => {
    ...
    // ── Income ────────────────────────────────────────────
    app.get('/portal/api/income', auth_1.authMiddleware, (req, res) => {
        res.json(db.prepare('SELECT * FROM bakery_income ORDER BY date DESC').all());
    });
    app.post('/portal/api/income', auth_1.authMiddleware, (req, res) => {
    ...
    app.get('/portal/api/expenses/:id/receipts', auth_1.authMiddleware, (req, res) => {
    ...
    app.get('/portal/api/expenses/:id/receipts/:rid', auth_1.authMiddleware, (req, res) => {
        const receipt = db.prepare('SELECT * FROM expense_receipts WHERE id=? AND expense_id=?').get(req.params.rid, req.params.id);
        if (!receipt) {
    ...
    app.delete('/portal/api/expenses/:id/receipts/:rid', auth_1.authMiddleware, (req, res) => {
    ...
    app.get('/portal/api/expenses/:id/receipt', auth_1.authMiddleware, (req, res) => {
        const receipt = db.prepare('SELECT * FROM expense_receipts WHERE expense_id=? ORDER BY uploaded_at ASC LIMIT 1').get(req.params.id);
        if (!receipt) {
    ...
    // ── Inventory ─────────────────────────────────────────
    app.get('/portal/api/inventory', auth_1.authMiddleware, (req, res) => {
    ...
    app.post('/portal/api/inventory', auth_1.authMiddleware, (req, res) => {
    ...
    app.patch('/portal/api/inventory/:id', auth_1.authMiddleware, (req, res) => {
    ...
    app.delete('/portal/api/inventory/:id', auth_1.authMiddleware, (req, res) => {
        db.prepare('DELETE FROM inventory_items WHERE id=?').run(req.params.id);
        res.json({ ok: true });
    });
    // ── Recipes ───────────────────────────────────────────
    app.get('/portal/api/recipes', auth_1.authMiddleware, (req, res) => {
        res.json(db.prepare('SELECT * FROM bakery_recipes ORDER BY name').all());
    });
    app.post('/portal/api/recipes', auth_1.authMiddleware, (req, res) => {
    ...
    // ── Suppliers ─────────────────────────────────────────
    app.get('/portal/api/suppliers', auth_1.authMiddleware, (req, res) => {
        res.json(db.prepare('SELECT * FROM suppliers ORDER BY name').all());
    });
    app.post('/portal/api/suppliers', auth_1.authMiddleware, (req, res) => {
    ...
    // ── Events ────────────────────────────────────────────
    app.get('/portal/api/events', auth_1.authMiddleware, (req, res) => {
        res.json(db.prepare('SELECT * FROM events ORDER BY date DESC').all());
    });
    app.post('/portal/api/events', auth_1.authMiddleware, (req, res) => {
    ...
    // ── Mileage ───────────────────────────────────────────
    app.get('/portal/api/mileage', auth_1.authMiddleware, (req, res) => {
        res.json(db.prepare('SELECT * FROM mileage_log ORDER BY date DESC').all());
    });
    app.post('/portal/api/mileage', auth_1.authMiddleware, (req, res) => {
    ...
    // ── Tax Export ────────────────────────────────────────
    app.get('/portal/api/taxes/export', auth_1.authMiddleware, (req, res) => {
    ...
    // ── Menu Management ───────────────────────────────────
    app.get('/portal/api/menu-items', auth_1.authMiddleware, (req, res) => {
        res.json(db.prepare('SELECT * FROM menu_items ORDER BY category, name').all());
    });
    app.patch('/portal/api/menu-items/:id', auth_1.authMiddleware, (req, res) => {
    ...
    app.post('/portal/api/menu-items', auth_1.authMiddleware, (req, res) => {
